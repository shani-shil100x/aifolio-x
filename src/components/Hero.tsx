  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gray-950">
      ...
      <div className="absolute inset-0">
        ...
        <div className="blob absolute bottom-20 right-20 w-96 h-96 bg-gradient-to-r from-cyan-600/15 via-blue-600/20 to-purple-600/15 animate-float" style={{ animationDelay: '2s' }}></div>
        <div className="blob absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-r from-pink-600/20 via-purple-600/15 to-cyan-600/20 animate-float-reverse" style={{ animationDelay: '4s' }}></div>
      </div>
      ...
      <div className="absolute inset-0 particles-container">
        {[...Array(8)].map((_, i) => (
          <div
            key={i}
            className="particle absolute w-1 h-1 bg-purple-400/40 rounded-full animate-float-particle"
            style={{
              left: `${15 + i * 12}%`,
              top: `${25 + (i % 4) * 20}%`,
      ...
      <div className="relative z-10 text-center container-spacing max-w-6xl">
        <div className="animate-fade-in-up-stagger">
          ...
          <div className="mb-12">
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold font-space mb-6 leading-tight">
          ...
          <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 justify-center items-center mb-12">
            ...
            <button
              ...
              className="group relative w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-purple-600 via-pink-600 to-cyan-500 rounded-xl text-white font-semibold text-lg overflow-hidden transform transition-all duration-500 hover:scale-105 hover:rotate-1 magnetic-hover neon-glow-enhanced"
            >
            ...
            <button
              ...
              className="group relative w-full sm:w-auto px-8 py-4 bg-gray-900/30 backdrop-blur-xl border-2 border-gray-700/50 rounded-xl text-white font-semibold text-lg overflow-hidden transform transition-all duration-500 hover:scale-105 hover:-rotate-1 hover:border-purple-500/50 glass-button"
            >
              {/* Background Glow */}
